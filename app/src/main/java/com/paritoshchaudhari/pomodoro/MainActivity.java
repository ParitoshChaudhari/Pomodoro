package com.paritoshchaudhari.pomodoro;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String mintAchieve="mints";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int achivements=Preferences.getInt(mintAchieve,-1);
